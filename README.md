...
This repo shows that you can automate any browser based backoffice process using Claude, and create a working, tested agentic automation within a day. All you need is context (observations how work gets done).
